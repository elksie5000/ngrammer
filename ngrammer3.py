...
class Document(object):
    ...
    def create_ngrams(self, n, t):
        ...
        #ngrams2 = list(zip(*[t[i:] for i in range(n)]))
        return ngrams
...
class Corpus:
    ...
    """
    AUTHORS = 'ABC' #Assume first letter is author_id
    def __init__(self):
        self.documents = {}
        self.summary = {}
        self.doc_count = 0
...
for boolean in [True, False]:
    for n in range(1, 21):
        ...
        print("Sample: ", corpus.documents[0].ngrams[10])
...
print("""In {0} separate tests, A was judged closer to C {1}
        ...
        """.format(no_tests, results['A'], results['B']))
